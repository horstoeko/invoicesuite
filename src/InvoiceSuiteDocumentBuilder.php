...
class InvoiceSuiteDocumentBuilder extends InvoiceSuiteAbstractDocumentBaseBuilder
{
    ...
    public function addDocumentSellerDescription(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentSellerDescription($newDescription);
    ...
    public function addDocumentSellerTaxRepresentativeDescription(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentSellerTaxRepresentativeDescription($newDescription);
    ...
    public function addDocumentSalesAgentDescription(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentSalesAgentDescription($newDescription);
    ...
    public function setDocumentBuyerAgentName(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentBuyerAgentName($newName);
    ...
    public function setDocumentBuyerAgentId(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentBuyerAgentId($newId);
    ...
    public function addDocumentBuyerAgentId(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentBuyerAgentId($newId);
    ...
    public function setDocumentBuyerAgentGlobalId(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentBuyerAgentGlobalId($newGlobalId, $newGlobalIdType);
    ...
    public function addDocumentBuyerAgentGlobalId(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentBuyerAgentGlobalId($newGlobalId, $newGlobalIdType);
    ...
    public function setDocumentBuyerAgentTaxRegistration(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentBuyerAgentTaxRegistration($newTaxRegistrationType, $newTaxRegistrationId);
    ...
    public function addDocumentBuyerAgentTaxRegistration(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentBuyerAgentTaxRegistration($newTaxRegistrationType, $newTaxRegistrationId);
    ...
    public function setDocumentBuyerAgentAddress(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentBuyerAgentAddress($newAddressLine1, $newAddressLine2, $newAddressLine3, $newPostcode, $newCity, $newCountryId, $newSubDivision);
    ...
    public function addDocumentBuyerAgentAddress(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentBuyerAgentAddress($newAddressLine1, $newAddressLine2, $newAddressLine3, $newPostcode, $newCity, $newCountryId, $newSubDivision);
    ...
    public function setDocumentBuyerAgentLegalOrganisation(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentBuyerAgentLegalOrganisation($newType, $newId, $newName);
    ...
    public function addDocumentBuyerAgentLegalOrganisation(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentBuyerAgentLegalOrganisation($newType, $newId, $newName);
    ...
    public function setDocumentBuyerAgentContact(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentBuyerAgentContact($newPersonName, $newDepartmentName, $newPhoneNumber, $newFaxNumber, $newEmailAddress);
    ...
    public function addDocumentBuyerAgentContact(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentBuyerAgentContact($newPersonName, $newDepartmentName, $newPhoneNumber, $newFaxNumber, $newEmailAddress);
    ...
    public function setDocumentBuyerAgentCommunication(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentBuyerAgentCommunication($newType, $newUri);
    ...
    public function addDocumentBuyerAgentCommunication(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentBuyerAgentCommunication($newType, $newUri);
    ...
    public function addDocumentProductEndUserDescription(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentProductEndUserDescription($newDescription);
    ...
    public function addDocumentUltimateShipToDescription(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentUltimateShipToDescription($newDescription);
    ...
    public function addDocumentInvoicerDescription(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentInvoicerDescription($newDescription);
    ...
    public function addDocumentPayeeDescription(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentPayeeDescription($newDescription);
    ...
    public function setDocumentPayerName(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentPayerName($newName);
    ...
    public function setDocumentPayerId(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentPayerId($newId);
    ...
    public function addDocumentPayerId(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentPayerId($newId);
    ...
    public function setDocumentPayerGlobalId(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentPayerGlobalId($newGlobalId, $newGlobalIdType);
    ...
    public function addDocumentPayerGlobalId(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentPayerGlobalId($newGlobalId, $newGlobalIdType);
    ...
    public function setDocumentPayerTaxRegistration(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentPayerTaxRegistration($newTaxRegistrationType, $newTaxRegistrationId);
    ...
    public function addDocumentPayerTaxRegistration(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentPayerTaxRegistration($newTaxRegistrationType, $newTaxRegistrationId);
    ...
    public function setDocumentPayerAddress(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentPayerAddress($newAddressLine1, $newAddressLine2, $newAddressLine3, $newPostcode, $newCity, $newCountryId, $newSubDivision);
    ...
    public function addDocumentPayerAddress(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentPayerAddress($newAddressLine1, $newAddressLine2, $newAddressLine3, $newPostcode, $newCity, $newCountryId, $newSubDivision);
    ...
    public function setDocumentPayerLegalOrganisation(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentPayerLegalOrganisation($newType, $newId, $newName);
    ...
    public function addDocumentPayerLegalOrganisation(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentPayerLegalOrganisation($newType, $newId, $newName);
    ...
    public function setDocumentPayerContact(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentPayerContact($newPersonName, $newDepartmentName, $newPhoneNumber, $newFaxNumber, $newEmailAddress);
    ...
    public function addDocumentPayerContact(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentPayerContact($newPersonName, $newDepartmentName, $newPhoneNumber, $newFaxNumber, $newEmailAddress);
    ...
    public function setDocumentPayerCommunication(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentPayerCommunication($newType, $newUri);
    ...
    public function addDocumentPayerCommunication(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentPayerCommunication($newType, $newUri);
    ...
    public function setDocumentSpecifiedAdvancePayment(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentSpecifiedAdvancePayment(
            $newPaidAmount,
            $newFormattedReceivedDateTime
        );
    ...
    public function addDocumentSpecifiedAdvancePayment(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentSpecifiedAdvancePayment(
            $newPaidAmount,
            $newFormattedReceivedDateTime
        );
    ...
    public function setDocumentSpecifiedAdvancePaymentIncludedTradeTax(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentSpecifiedAdvancePaymentIncludedTradeTax(
            $newTaxCategory,
            $newTaxType,
            $newTaxAmount,
            $newTaxPercent,
    ...
    public function addDocumentSpecifiedAdvancePaymentIncludedTradeTax(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentSpecifiedAdvancePaymentIncludedTradeTax(
            $newTaxCategory,
            $newTaxType,
            $newTaxAmount,
            $newTaxPercent,
    ...
    public function setDocumentSpecifiedAdvancePaymentInvoiceReference(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->setDocumentSpecifiedAdvancePaymentInvoiceReference(
            $newReferenceNumber,
            $newReferenceDate,
            $newTypeCode
        );
    ...
    public function addDocumentPositionShipToDescription(
        ...
        $this->getCurrentDocumentFormatProvider()->getBuilder()->addDocumentPositionShipToDescription($newDescription);
