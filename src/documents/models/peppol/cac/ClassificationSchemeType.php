...
use horstoeko\invoicesuite\documents\models\peppol\cbc\AgencyID;
use horstoeko\invoicesuite\documents\models\peppol\cbc\AgencyName;
...
use horstoeko\invoicesuite\documents\models\peppol\cbc\SchemeURI;
use horstoeko\invoicesuite\documents\models\peppol\cbc\URI;
...
class ClassificationSchemeType
{
     ...
     * @var null|AgencyID
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\AgencyID")
     * @JMS\Expose
     ...
     * @var null|AgencyName
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\AgencyName")
     * @JMS\Expose
     ...
     * @var null|URI
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\URI")
     * @JMS\Expose
     ...
     * @var null|SchemeURI
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\SchemeURI")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\ClassificationCategory>")
     * @JMS\Expose
