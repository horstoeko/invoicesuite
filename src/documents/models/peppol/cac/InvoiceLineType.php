...
use horstoeko\invoicesuite\documents\models\peppol\cbc\InvoicedQuantity;
...
class InvoiceLineType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\InvoicedQuantity")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\SubInvoiceLine>")
     * @JMS\Expose
