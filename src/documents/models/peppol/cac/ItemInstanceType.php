...
use horstoeko\invoicesuite\documents\models\peppol\cbc\ProductTraceID;
use horstoeko\invoicesuite\documents\models\peppol\cbc\RegistrationID;
use horstoeko\invoicesuite\documents\models\peppol\cbc\SerialID;
...
class ItemInstanceType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ProductTraceID")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\RegistrationID")
     * @JMS\Expose
     ...
     * @var null|SerialID
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\SerialID")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\LotIdentification")
     * @JMS\Expose
