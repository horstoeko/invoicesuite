...
use horstoeko\invoicesuite\documents\models\peppol\cbc\AllowanceChargeReason;
use horstoeko\invoicesuite\documents\models\peppol\cbc\AllowanceChargeReasonCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\Amount;
use horstoeko\invoicesuite\documents\models\peppol\cbc\BaseAmount;
use horstoeko\invoicesuite\documents\models\peppol\cbc\ID;
use horstoeko\invoicesuite\documents\models\peppol\cbc\MultiplierFactorNumeric;
use horstoeko\invoicesuite\documents\models\peppol\cbc\PerUnitAmount;
...
class AllowanceChargeType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\AllowanceChargeReasonCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\AllowanceChargeReason>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\MultiplierFactorNumeric")
     * @JMS\Expose
     ...
     * @var null|BaseAmount
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\BaseAmount")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\PerUnitAmount")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\TaxCategory>")
     * @JMS\Expose
     ...
     * @var null|TaxTotal
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\TaxTotal")
     * @JMS\Expose
