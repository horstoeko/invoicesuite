...
use horstoeko\invoicesuite\documents\models\peppol\cbc\LowTendersDescription;
use horstoeko\invoicesuite\documents\models\peppol\cbc\PaymentDescription;
use horstoeko\invoicesuite\documents\models\peppol\cbc\PrizeDescription;
use horstoeko\invoicesuite\documents\models\peppol\cbc\TechnicalCommitteeDescription;
use horstoeko\invoicesuite\documents\models\peppol\cbc\WeightingAlgorithmCode;
...
class AwardingTermsType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\WeightingAlgorithmCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\TechnicalCommitteeDescription>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\LowTendersDescription>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\PrizeDescription>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\PaymentDescription>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\AwardingCriterion>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\TechnicalCommitteePerson>")
     * @JMS\Expose
