...
use horstoeko\invoicesuite\documents\models\peppol\cbc\DeclarationTypeCode;
...
class DeclarationType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\DeclarationTypeCode")
     * @JMS\Expose
