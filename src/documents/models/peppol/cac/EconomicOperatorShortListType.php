...
use horstoeko\invoicesuite\documents\models\peppol\cbc\ExpectedQuantity;
use horstoeko\invoicesuite\documents\models\peppol\cbc\LimitationDescription;
...
class EconomicOperatorShortListType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\LimitationDescription>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ExpectedQuantity")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\PreSelectedParty>")
     * @JMS\Expose
