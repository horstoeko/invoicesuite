...
use horstoeko\invoicesuite\documents\models\peppol\cbc\MaximumPercent;
use horstoeko\invoicesuite\documents\models\peppol\cbc\MinimumPercent;
use horstoeko\invoicesuite\documents\models\peppol\cbc\Rate;
use horstoeko\invoicesuite\documents\models\peppol\cbc\SubcontractingConditionsCode;
...
class SubcontractTermsType
{
     ...
     * @var null|Rate
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\Rate")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\SubcontractingConditionsCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\MaximumPercent")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\MinimumPercent")
     * @JMS\Expose
