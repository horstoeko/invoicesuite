...
use horstoeko\invoicesuite\documents\models\peppol\cbc\ExpectedOperatorQuantity;
use horstoeko\invoicesuite\documents\models\peppol\cbc\Frequency;
use horstoeko\invoicesuite\documents\models\peppol\cbc\Justification;
use horstoeko\invoicesuite\documents\models\peppol\cbc\MaximumOperatorQuantity;
...
class FrameworkAgreementType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ExpectedOperatorQuantity")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\MaximumOperatorQuantity")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\Justification>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\Frequency>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\SubsequentProcessTenderRequirement>")
     * @JMS\Expose
