...
use horstoeko\invoicesuite\documents\models\peppol\cbc\UtilityStatementTypeCode;
...
class ConsumptionType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\UtilityStatementTypeCode")
     * @JMS\Expose
     ...
     * @var null|MainPeriod
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\MainPeriod")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\EnergyWaterSupply")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\TelecommunicationsSupply")
     * @JMS\Expose
