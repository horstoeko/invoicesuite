...
use horstoeko\invoicesuite\documents\models\peppol\cbc\ExceptionResolutionCode;
...
use horstoeko\invoicesuite\documents\models\peppol\cbc\ThresholdQuantity;
use horstoeko\invoicesuite\documents\models\peppol\cbc\ThresholdValueComparisonCode;
...
class ExceptionCriteriaLineType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ThresholdValueComparisonCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ThresholdQuantity")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ExceptionResolutionCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\EffectivePeriod")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\SupplyItem>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\ForecastExceptionCriterionLine")
     * @JMS\Expose
