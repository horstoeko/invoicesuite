...
use horstoeko\invoicesuite\documents\models\peppol\cbc\StatusCode;
...
class PriceListType
{
     ...
     * @var null|StatusCode
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\StatusCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\PreviousPriceList")
     * @JMS\Expose
