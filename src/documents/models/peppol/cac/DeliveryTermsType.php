...
use horstoeko\invoicesuite\documents\models\peppol\cbc\LossRisk;
use horstoeko\invoicesuite\documents\models\peppol\cbc\LossRiskResponsibilityCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\SpecialTerms;
...
class DeliveryTermsType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\SpecialTerms>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\LossRiskResponsibilityCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\LossRisk>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\AllowanceCharge")
     * @JMS\Expose
