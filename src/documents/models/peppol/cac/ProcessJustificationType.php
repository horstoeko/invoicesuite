...
use horstoeko\invoicesuite\documents\models\peppol\cbc\PreviousCancellationReasonCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\ProcessReason;
use horstoeko\invoicesuite\documents\models\peppol\cbc\ProcessReasonCode;
...
class ProcessJustificationType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\PreviousCancellationReasonCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ProcessReasonCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\ProcessReason>")
     * @JMS\Expose
