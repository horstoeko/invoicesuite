...
use horstoeko\invoicesuite\documents\models\peppol\cbc\CharacterSetCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\Description;
use horstoeko\invoicesuite\documents\models\peppol\cbc\DocumentHash;
use horstoeko\invoicesuite\documents\models\peppol\cbc\EncodingCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\FileName;
use horstoeko\invoicesuite\documents\models\peppol\cbc\FormatCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\HashAlgorithmMethod;
use horstoeko\invoicesuite\documents\models\peppol\cbc\MimeCode;
...
class ExternalReferenceType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\DocumentHash")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\HashAlgorithmMethod")
     * @JMS\Expose
     ...
     * @var null|MimeCode
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\MimeCode")
     * @JMS\Expose
     ...
     * @var null|FormatCode
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\FormatCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\EncodingCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\CharacterSetCode")
     * @JMS\Expose
     ...
     * @var null|FileName
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\FileName")
     * @JMS\Expose
