...
use horstoeko\invoicesuite\documents\models\peppol\cbc\ConsumptionLevel;
use horstoeko\invoicesuite\documents\models\peppol\cbc\ConsumptionLevelCode;
...
class ConsumptionHistoryType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ConsumptionLevelCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ConsumptionLevel")
     * @JMS\Expose
