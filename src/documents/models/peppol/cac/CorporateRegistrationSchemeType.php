...
use horstoeko\invoicesuite\documents\models\peppol\cbc\CorporateRegistrationTypeCode;
...
class CorporateRegistrationSchemeType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\CorporateRegistrationTypeCode")
     * @JMS\Expose
