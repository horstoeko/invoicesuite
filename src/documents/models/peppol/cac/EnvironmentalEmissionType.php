...
use horstoeko\invoicesuite\documents\models\peppol\cbc\EnvironmentalEmissionTypeCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\ValueMeasure;
...
class EnvironmentalEmissionType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\EnvironmentalEmissionTypeCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ValueMeasure")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\EmissionCalculationMethod>")
     * @JMS\Expose
