...
use horstoeko\invoicesuite\documents\models\peppol\cbc\BarcodeSymbologyID;
use horstoeko\invoicesuite\documents\models\peppol\cbc\ExtendedID;
...
class ItemIdentificationType
{
     ...
     * @var null|ExtendedID
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ExtendedID")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\BarcodeSymbologyID")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\PhysicalAttribute>")
     * @JMS\Expose
