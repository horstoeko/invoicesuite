...
use horstoeko\invoicesuite\documents\models\peppol\cbc\DescriptionCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\PositionCode;
...
class PhysicalAttributeType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\PositionCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\DescriptionCode")
     * @JMS\Expose
