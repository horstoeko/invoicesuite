...
use horstoeko\invoicesuite\documents\models\peppol\cbc\TypeCode;
...
class EventType
{
     ...
     * @var null|TypeCode
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\TypeCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\OccurenceLocation")
     * @JMS\Expose
