...
use horstoeko\invoicesuite\documents\models\peppol\cbc\MandateTypeCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\MaximumPaidAmount;
use horstoeko\invoicesuite\documents\models\peppol\cbc\MaximumPaymentInstructionsNumeric;
use horstoeko\invoicesuite\documents\models\peppol\cbc\SignatureID;
...
class PaymentMandateType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\MandateTypeCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\MaximumPaymentInstructionsNumeric")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\MaximumPaidAmount")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\SignatureID")
     * @JMS\Expose
     ...
     * @var null|PayerParty
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\PayerParty")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\PaymentReversalPeriod")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\Clause>")
     * @JMS\Expose
