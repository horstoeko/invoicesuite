...
use horstoeko\invoicesuite\documents\models\peppol\cbc\PerformanceValueQuantity;
...
class PerformanceDataLineType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\PerformanceValueQuantity")
     * @JMS\Expose
