...
use horstoeko\invoicesuite\documents\models\peppol\cbc\CapabilityTypeCode;
...
class CapabilityType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\CapabilityTypeCode")
     * @JMS\Expose
