...
use horstoeko\invoicesuite\documents\models\peppol\cbc\MaximumNumberNumeric;
use horstoeko\invoicesuite\documents\models\peppol\cbc\MinimumNumberNumeric;
use horstoeko\invoicesuite\documents\models\peppol\cbc\OptionsDescription;
...
class ContractExtensionType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\OptionsDescription>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\MinimumNumberNumeric")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\MaximumNumberNumeric")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\OptionValidityPeriod")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\Renewal>")
     * @JMS\Expose
