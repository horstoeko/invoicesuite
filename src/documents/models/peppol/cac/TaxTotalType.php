...
use horstoeko\invoicesuite\documents\models\peppol\cbc\RoundingAmount;
...
class TaxTotalType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\RoundingAmount")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\TaxSubtotal>")
     * @JMS\Expose
