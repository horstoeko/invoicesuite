...
use horstoeko\invoicesuite\documents\models\peppol\cbc\ParentDocumentLineReferenceID;
...
class ConsumptionLineType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\ParentDocumentLineReferenceID")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\UtilityItem")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\UnstructuredPrice")
     * @JMS\Expose
