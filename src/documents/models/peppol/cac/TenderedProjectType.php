...
use horstoeko\invoicesuite\documents\models\peppol\cbc\FeeAmount;
use horstoeko\invoicesuite\documents\models\peppol\cbc\FeeDescription;
use horstoeko\invoicesuite\documents\models\peppol\cbc\TenderEnvelopeID;
use horstoeko\invoicesuite\documents\models\peppol\cbc\TenderEnvelopeTypeCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\VariantID;
...
class TenderedProjectType
{
     ...
     * @var null|VariantID
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\VariantID")
     * @JMS\Expose
     ...
     * @var null|FeeAmount
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\FeeAmount")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\TenderEnvelopeID")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\TenderEnvelopeTypeCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\ProcurementProjectLot")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\EvidenceDocumentReference>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\TenderLine>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\AwardingCriterionResponse>")
     * @JMS\Expose
