...
use horstoeko\invoicesuite\documents\models\peppol\cbc\AwardingCriterionDescription;
use horstoeko\invoicesuite\documents\models\peppol\cbc\AwardingCriterionID;
...
class AwardingCriterionResponseType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\AwardingCriterionID")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\AwardingCriterionDescription>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\SubordinateAwardingCriterionResponse>")
     * @JMS\Expose
