...
use horstoeko\invoicesuite\documents\models\peppol\cbc\LeadTimeMeasure;
...
use horstoeko\invoicesuite\documents\models\peppol\cbc\TradingRestrictions;
...
class ItemLocationQuantityType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\LeadTimeMeasure")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cbc\TradingRestrictions>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\ApplicableTerritoryAddress>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\ApplicableTaxCategory>")
     * @JMS\Expose
     ...
     * @var null|Package
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\Package")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\DependentPriceReference")
     * @JMS\Expose
