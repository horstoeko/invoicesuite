...
use horstoeko\invoicesuite\documents\models\peppol\cbc\PromotionalEventTypeCode;
...
class PromotionalEventType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\PromotionalEventTypeCode")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\PromotionalSpecification>")
     * @JMS\Expose
