...
use horstoeko\invoicesuite\documents\models\peppol\cbc\SecurityClassificationCode;
...
class RequestForQuotationLineType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\SecurityClassificationCode")
     * @JMS\Expose
