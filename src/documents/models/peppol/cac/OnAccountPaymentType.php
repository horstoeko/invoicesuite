...
use horstoeko\invoicesuite\documents\models\peppol\cbc\EstimatedConsumedQuantity;
...
class OnAccountPaymentType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\EstimatedConsumedQuantity")
     * @JMS\Expose
