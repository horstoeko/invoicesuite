...
use horstoeko\invoicesuite\documents\models\peppol\cbc\LineNumberNumeric;
...
class EventLineItemType
{
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cbc\LineNumberNumeric")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\peppol\cac\ParticipatingLocationsLocation")
     * @JMS\Expose
     ...
     * @JMS\Groups({"ubl"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\peppol\cac\RetailPlannedImpact>")
     * @JMS\Expose
