...
class InvoiceSuiteZfFxProviderBuilder extends InvoiceSuiteAbstractDocumentFormatBuilder
{
    ...
    public function createFromDTO(
        ...
        $newDocumentDTO->forEachNote(fn (InvoiceSuiteNoteDTO $note): static => $this->addDocumentNote(
            $note->getContent(),
            $note->getContentCode(),
            $note->getSubjectCode()
        ));
        ...
        $newDocumentDTO->forEachOrFirstPostingReference(
            ...
            fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentPostingReference(
                $item->getIdType(),
                $item->getId()
            )
        );
        ...
        $newDocumentDTO->firstQuotationReference(
            fn (InvoiceSuiteReferenceDocumentDTO $item): static => $this->setDocumentQuotationReference(
                $item->getReferenceNumber(),
                $item->getReferenceDate()
            )
        );
        ...
        $newDocumentDTO->forEachUltimateCustomerOrderReference(
            fn (InvoiceSuiteReferenceDocumentDTO $item): static => $this->addDocumentUltimateCustomerOrderReference(
                $item->getReferenceNumber(),
                $item->getReferenceDate()
            )
        );
        ...
        $newDocumentDTO->firstDeliveryNoteReference(
            fn (InvoiceSuiteReferenceDocumentDTO $item): static => $this->setDocumentDeliveryNoteReference(
                $item->getReferenceNumber(),
                $item->getReferenceDate()
            )
        );
        ...
        $newDocumentDTO
            ...
            ?->forEachOrFirstContact(
                $this->supportsAtLeastExtended(),
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentSellerContact(
                    $item->getPersonName(),
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentBuyerGlobalId($item->getId(), $item->getIdType())
            )
            ...
            ?->forEachOrFirstContact(
                $this->supportsAtLeastExtended(),
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentBuyerContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentSellerTaxRepresentativeGlobalId($item->getId(), $item->getIdType())
            )
            ?->firstTaxRegistration(
            ...
            ?->firstLegalOrganisation(
                fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentSellerTaxRepresentativeLegalOrganisation(
                    $item->getIdType(),
                    $item->getId(),
                    $item->getName()
                )
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentSellerTaxRepresentativeContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
            ...
            ?->firstCommunication(
                fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentSellerTaxRepresentativeCommunication(
                    $item->getIdType(),
                    $item->getId()
                )
            );
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentBuyerTaxRepresentativeGlobalId($item->getId(), $item->getIdType())
            )
            ?->firstTaxRegistration(
                fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentBuyerTaxRepresentativeTaxRegistration($item->getIdType(), $item->getId())
            )
            ?->firstAddress(
                fn (InvoiceSuiteAddressDTO $item): static => $this->setDocumentBuyerTaxRepresentativeAddress(
                    $item->getAddressLine1(),
                    $item->getAddressLine2(),
                    $item->getAddressLine3(),
                    $item->getPostcode(),
            ...
            ?->firstLegalOrganisation(
                fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentBuyerTaxRepresentativeLegalOrganisation(
                    $item->getIdType(),
                    $item->getId(),
                    $item->getName()
                )
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentBuyerTaxRepresentativeContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
            ...
            ?->firstCommunication(
                fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentBuyerTaxRepresentativeCommunication(
                    $item->getIdType(),
                    $item->getId()
                )
            );
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentProductEndUserGlobalId($item->getId(), $item->getIdType())
            )
            ?->firstTaxRegistration(
                fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentProductEndUserTaxRegistration($item->getIdType(), $item->getId())
            )
            ?->firstAddress(
                fn (InvoiceSuiteAddressDTO $item): static => $this->setDocumentProductEndUserAddress(
                    $item->getAddressLine1(),
                    $item->getAddressLine2(),
                    $item->getAddressLine3(),
                    $item->getPostcode(),
            ...
            ?->firstLegalOrganisation(
                fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentProductEndUserLegalOrganisation(
                    $item->getIdType(),
                    $item->getId(),
                    $item->getName()
                )
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentProductEndUserContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
            ...
            ?->firstCommunication(
                fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentProductEndUserCommunication(
                    $item->getIdType(),
                    $item->getId()
                )
            );
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentShipToGlobalId($item->getId(), $item->getIdType())
            )
            ?->firstTaxRegistration(
                fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentShipToTaxRegistration($item->getIdType(), $item->getId())
            )
            ?->firstAddress(
            ...
            ?->firstLegalOrganisation(
                fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentShipToLegalOrganisation(
                    $item->getIdType(),
                    $item->getId(),
                    $item->getName()
                )
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentShipToContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
            ...
            ?->firstCommunication(
                fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentShipToCommunication(
                    $item->getIdType(),
                    $item->getId()
                )
            );
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentUltimateShipToGlobalId($item->getId(), $item->getIdType())
            )
            ?->firstTaxRegistration(
                fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentUltimateShipToTaxRegistration($item->getIdType(), $item->getId())
            )
            ?->firstAddress(
                fn (InvoiceSuiteAddressDTO $item): static => $this->setDocumentUltimateShipToAddress(
                    $item->getAddressLine1(),
                    $item->getAddressLine2(),
                    $item->getAddressLine3(),
                    $item->getPostcode(),
            ...
            ?->firstLegalOrganisation(
                fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentUltimateShipToLegalOrganisation(
                    $item->getIdType(),
                    $item->getId(),
                    $item->getName()
                )
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentUltimateShipToContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
            ...
            ?->firstCommunication(
                fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentUltimateShipToCommunication(
                    $item->getIdType(),
                    $item->getId()
                )
            );
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentShipFromGlobalId($item->getId(), $item->getIdType())
            )
            ?->firstTaxRegistration(
                fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentShipFromTaxRegistration($item->getIdType(), $item->getId())
            )
            ?->firstAddress(
                fn (InvoiceSuiteAddressDTO $item): static => $this->setDocumentShipFromAddress(
                    $item->getAddressLine1(),
                    $item->getAddressLine2(),
                    $item->getAddressLine3(),
                    $item->getPostcode(),
            ...
            ?->firstLegalOrganisation(
                fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentShipFromLegalOrganisation(
                    $item->getIdType(),
                    $item->getId(),
                    $item->getName()
                )
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentShipFromContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
            ...
            ?->firstCommunication(
                fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentShipFromCommunication(
                    $item->getIdType(),
                    $item->getId()
                )
            );
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentInvoicerGlobalId($item->getId(), $item->getIdType())
            )
            ?->firstTaxRegistration(
                fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentInvoicerTaxRegistration($item->getIdType(), $item->getId())
            )
            ?->firstAddress(
                fn (InvoiceSuiteAddressDTO $item): static => $this->setDocumentInvoicerAddress(
                    $item->getAddressLine1(),
                    $item->getAddressLine2(),
                    $item->getAddressLine3(),
                    $item->getPostcode(),
            ...
            ?->firstLegalOrganisation(
                fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentInvoicerLegalOrganisation(
                    $item->getIdType(),
                    $item->getId(),
                    $item->getName()
                )
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentInvoicerContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
            ...
            ?->firstCommunication(
                fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentInvoicerCommunication(
                    $item->getIdType(),
                    $item->getId()
                )
            );
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentInvoiceeGlobalId($item->getId(), $item->getIdType())
            )
            ?->firstTaxRegistration(
                fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentInvoiceeTaxRegistration($item->getIdType(), $item->getId())
            )
            ?->firstAddress(
                fn (InvoiceSuiteAddressDTO $item): static => $this->setDocumentInvoiceeAddress(
                    $item->getAddressLine1(),
                    $item->getAddressLine2(),
                    $item->getAddressLine3(),
                    $item->getPostcode(),
            ...
            ?->firstLegalOrganisation(
                fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentInvoiceeLegalOrganisation(
                    $item->getIdType(),
                    $item->getId(),
                    $item->getName()
                )
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentInvoiceeContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
            ...
            ?->firstCommunication(
                fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentInvoiceeCommunication(
                    $item->getIdType(),
                    $item->getId()
                )
            );
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentPayeeGlobalId(
                    $item->getId(),
                    $item->getIdType()
                )
            )
            ?->firstTaxRegistration(
                fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentPayeeTaxRegistration(
                    $item->getIdType(),
                    $item->getId()
                )
            )
            ?->firstAddress(
                fn (InvoiceSuiteAddressDTO $item): static => $this->setDocumentPayeeAddress(
                    $item->getAddressLine1(),
                    $item->getAddressLine2(),
                    $item->getAddressLine3(),
                    $item->getPostcode(),
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentPayeeContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
            ...
            ?->firstCommunication(
                fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentPayeeCommunication(
                    $item->getIdType(),
                    $item->getId()
                )
            );
        ...
        $newDocumentDTO
            ...
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentPayerGlobalId(
                    $item->getId(),
                    $item->getIdType()
                )
            )
            ?->firstTaxRegistration(
                fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentPayerTaxRegistration(
                    $item->getIdType(),
                    $item->getId()
                )
            )
            ?->firstAddress(
                fn (InvoiceSuiteAddressDTO $item): static => $this->setDocumentPayerAddress(
                    $item->getAddressLine1(),
                    $item->getAddressLine2(),
                    $item->getAddressLine3(),
                    $item->getPostcode(),
            ...
            ?->firstLegalOrganisation(
                fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentPayerLegalOrganisation(
                    $item->getIdType(),
                    $item->getId(),
                    $item->getName()
                )
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentPayerContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
            ...
            ?->firstCommunication(
                fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentPayerCommunication(
                    $item->getIdType(),
                    $item->getId()
                )
            );
        ...
        $newDocumentDTO->forEachOrFirstPaymentTerm(
            ...
            function (InvoiceSuitePaymentTermDTO $item): void {
                ...
                $item->firstDiscountTerm(
                    fn (InvoiceSuitePaymentTermDiscountDTO $item): static => $this->setDocumentPaymentDiscountTermsInLastPaymentTerm(
                        $item->getBaseAmount(),
                ...
                $item->firstPenaltyTerm(
                    fn (InvoiceSuitePaymentTermPenaltyDTO $item): static => $this->setDocumentPaymentPenaltyTermsInLastPaymentTerm(
                        $item->getBaseAmount(),
        ...
        $newDocumentDTO->forEachServiceCharge(
            fn (InvoiceSuiteServiceChargeDTO $item): static => $this->addDocumentLogisticServiceCharge(
                $item->getAmount(),
                $item->getDescription(),
                $item->getTaxCategory(),
                $item->getTaxType(),
        ...
        $newDocumentDTO->forEachPosition(
            function (InvoiceSuiteDocumentPositionDTO $item): void {
                ...
                $item->forEachOrFirstNote(
                    $this->supportsAtLeastExtended(),
                    fn (InvoiceSuiteNoteDTO $itemNote): static => $this->addDocumentPositionNote(
                        $itemNote->getContent(),
                ...
                $item->getProduct()?->forEachReferenceProduct(
                    fn (InvoiceSuiteReferenceProductDTO $referencedProduct): static => $this->addDocumentPositionReferencedProduct(
                ...
                $item->firstSellerOrderReference(
                    fn (InvoiceSuiteReferenceDocumentLineDTO $item): static => $this->setDocumentPositionSellerOrderReference(
                        $item->getReferenceNumber(),
                ...
                $item->firstQuotationReference(
                    fn (InvoiceSuiteReferenceDocumentLineDTO $item): static => $this->setDocumentPositionQuotationReference(
                        $item->getReferenceNumber(),
                        $item->getReferenceLineNumber(),
                        $item->getReferenceDate()
                    )
                ...
                $item->firstContractReference(
                    fn (InvoiceSuiteReferenceDocumentLineDTO $item): static => $this->setDocumentPositionContractReference(
                        $item->getReferenceNumber(),
                        $item->getReferenceLineNumber(),
                        $item->getReferenceDate()
                    )
                ...
                $item->forEachAdditionalReference(
                    fn (InvoiceSuiteReferenceDocumentLineExtDTO $item): static => $this->addDocumentPositionAdditionalReference(
                        $item->getReferenceNumber(),
                        $item->getReferenceLineNumber(),
                        $item->getReferenceDate(),
                        $item->getTypeCode(),
                ...
                $item->forEachUltimateCustomerOrderReference(
                    fn (InvoiceSuiteReferenceDocumentLineDTO $item): static => $this->addDocumentPositionUltimateCustomerOrderReference(
                        $item->getReferenceNumber(),
                        $item->getReferenceLineNumber(),
                        $item->getReferenceDate()
                    )
                ...
                $item->firstDespatchAdviceReference(
                    fn (InvoiceSuiteReferenceDocumentLineDTO $item): static => $this->setDocumentPositionDespatchAdviceReference(
                        $item->getReferenceNumber(),
                        $item->getReferenceLineNumber(),
                        $item->getReferenceDate()
                    )
                ...
                $item->firstReceivingAdviceReference(
                    fn (InvoiceSuiteReferenceDocumentLineDTO $item): static => $this->setDocumentPositionReceivingAdviceReference(
                        $item->getReferenceNumber(),
                        $item->getReferenceLineNumber(),
                        $item->getReferenceDate()
                    )
                ...
                $item->firstDeliveryNoteReference(
                    fn (InvoiceSuiteReferenceDocumentLineDTO $item): static => $this->setDocumentPositionDeliveryNoteReference(
                        $item->getReferenceNumber(),
                        $item->getReferenceLineNumber(),
                        $item->getReferenceDate()
                    )
                ...
                $item->firstInvoiceReference(
                    fn (InvoiceSuiteReferenceDocumentLineExtDTO $item): static => $this->setDocumentPositionInvoiceReference(
                        $item->getReferenceNumber(),
                        $item->getReferenceLineNumber(),
                        $item->getReferenceDate(),
                        $item->getTypeCode()
                ...
                $item->forEachOrFirstAdditionalObjectReference(
                    $this->supportsAtLeastExtended(),
                    fn (InvoiceSuiteReferenceDocumentExtDTO $item): static => $this->addDocumentPositionAdditionalObjectReference(
                        $item->getReferenceNumber(),
                        $item->getTypeCode(),
                        $item->getReferenceTypeCode()
                    )
                ...
                $item->getGrossPrice()?->forEachOrFirstAllowanceCharge(
                    $this->supportsAtLeastExtended(),
                    fn (InvoiceSuiteAllowanceChargeDTO $itemGrossPriceAllowanceCharge): static => $this->addDocumentPositionGrossPriceAllowanceCharge(
                ...
                $item->getNetPrice()?->firstTax(
                    fn (InvoiceSuiteTaxDTO $netPriceTax): static => $this->setDocumentPositionNetPriceTax(
                ...
                $item->getShipToParty()
                    ...
                    ?->forEachGlobalId(
                        fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentPositionShipToGlobalId($item->getId(), $item->getIdType())
                    )
                    ?->firstTaxRegistration(
                        fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentPositionShipToTaxRegistration($item->getIdType(), $item->getId())
                    )
                    ?->firstAddress(
                        fn (InvoiceSuiteAddressDTO $item): static => $this->setDocumentPositionShipToAddress(
                            $item->getAddressLine1(),
                            $item->getAddressLine2(),
                            $item->getAddressLine3(),
                            $item->getPostcode(),
                    ...
                    ?->firstLegalOrganisation(
                        fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentPositionShipToLegalOrganisation(
                            $item->getIdType(),
                            $item->getId(),
                            $item->getName()
                        )
                    ...
                    ?->forEachContact(
                        fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentPositionShipToContact(
                            $item->getPersonName(),
                            $item->getDepartmentName(),
                            $item->getPhoneNumber(),
                            $item->getFaxNumber(),
                    ...
                    ?->firstCommunication(
                        fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentPositionShipToCommunication(
                            $item->getIdType(),
                            $item->getId()
                        )
                    );
                ...
                $item->getUltimateShipToParty()
                    ...
                    ?->forEachGlobalId(
                        fn (InvoiceSuiteIdDTO $item): static => $this->addDocumentPositionUltimateShipToGlobalId($item->getId(), $item->getIdType())
                    )
                    ?->firstTaxRegistration(
                        fn (InvoiceSuiteIdDTO $item): static => $this->setDocumentPositionUltimateShipToTaxRegistration($item->getIdType(), $item->getId())
                    )
                    ?->firstAddress(
                        fn (InvoiceSuiteAddressDTO $item): static => $this->setDocumentPositionUltimateShipToAddress(
                            $item->getAddressLine1(),
                            $item->getAddressLine2(),
                            $item->getAddressLine3(),
                            $item->getPostcode(),
                    ...
                    ?->firstLegalOrganisation(
                        fn (InvoiceSuiteOrganisationDTO $item): static => $this->setDocumentPositionUltimateShipToLegalOrganisation(
                            $item->getIdType(),
                            $item->getId(),
                            $item->getName()
                        )
                    ...
                    ?->forEachContact(
                        fn (InvoiceSuiteContactDTO $item): static => $this->addDocumentPositionUltimateShipToContact(
                            $item->getPersonName(),
                            $item->getDepartmentName(),
                            $item->getPhoneNumber(),
                            $item->getFaxNumber(),
                    ...
                    ?->firstCommunication(
                        fn (InvoiceSuiteCommunicationDTO $item): static => $this->setDocumentPositionUltimateShipToCommunication(
                            $item->getIdType(),
                            $item->getId()
                        )
                    );
                ...
                $item->firstSupplyChainEvent(
                    fn (DateTimeInterface $supplyChainEvent): static => $this->setDocumentPositionSupplyChainEvent($supplyChainEvent)
                );

                // Position billing period

                $item->firstBillingPeriod(
                    fn (InvoiceSuiteDateRangeDTO $billingPeriod): static => $this->setDocumentPositionBillingPeriod(
                ...
                $item->forEachOrFirstTax(
                    $this->supportsAtLeastExtended(),
                    fn (InvoiceSuiteTaxDTO $tax): static => $this->addDocumentPositionTax(
                        $tax->getCategory(),
                        $tax->getType(),
                        $tax->getAmount(),
                        $tax->getPercent(),
                ...
                $item->forEachOrFirstPostingReference(
                    $this->supportsAtLeastExtended(),
                    fn (InvoiceSuiteIdDTO $postingReference): static => $this->addDocumentPositionPostingReference(
     ...
     *
     * @param  null|string $newId __BT-X-408, From EXTENDED__ An identifier of the party. In many systems, identification is key information.
     * @return static
     */
    public function setDocumentBuyerAgentId(
        ...
        $this->addDocumentBuyerAgentId($newId);
     ...
     *
     * @param  null|string $newGlobalId     __BT-X-409, From EXTENDED__ A global identifier of the party
     * @param  null|string $newGlobalIdType __BT-X-409-0, From EXTENDED__ Type of the global identifier of the party
     * @return static
     */
    public function setDocumentBuyerAgentGlobalId(
        ...
        $this->addDocumentBuyerAgentGlobalId($newGlobalId, $newGlobalIdType);
     ...
     *
     * @param  null|string $newTaxRegistrationType __BT-X-411-0, From EXTENDED__ Type of tax identification number of the party (e.g. FC = Tax number or VA = Sales tax identification number).
     * @param  null|string $newTaxRegistrationId   __BT-X-411, From EXTENDED__ Tax identification number
     * @return static
     */
    public function setDocumentBuyerAgentTaxRegistration(
        ...
        $this->addDocumentBuyerAgentTaxRegistration($newTaxRegistrationType, $newTaxRegistrationId);
     ...
     *
     * @param  null|string $newAddressLine1 __BT-X-420, From EXTENDED__ The main line in the address. This is usually the street name and house number or the post office box.
     * @param  null|string $newAddressLine2 __BT-X-421, From EXTENDED__ Line 2 of the address. This is an additional address line in an address that can be used to provide additional details in addition to the main line.
     * @param  null|string $newAddressLine3 __BT-X-422, From EXTENDED__ Line 3 of the address. This is an additional address line in an address that can be used to provide additional details in addition to the main line.
     * @param  null|string $newPostcode     __BT-X-419, From EXTENDED__ Zip code of the city or municipality in which the party's address is located
     * @param  null|string $newCity         __BT-X-423, From EXTENDED__ Name of the city or municipality in which the party's address is located
     * @param  null|string $newCountryId    __BT-X-424, From EXTENDED__ Country in which the party's address is located
     * @param  null|string $newSubDivision  __BT-X-425, From EXTENDED__ Region or federal state in which the party's address is located
     * @return static
     */
    public function setDocumentBuyerAgentAddress(
        ...
        $buyerAgentTradeParty = $this
            ->getCrossIndustryRootObject()
            ->getSupplyChainTradeTransactionWithCreate()
            ->getApplicableHeaderTradeAgreementWithCreate()
            ->getBuyerAgentTradePartyWithCreate();

        $buyerAgentTradeParty->getPostalTradeAddressWithCreate()->getCountryIDWithCreate()->setValue($newCountryId);

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newAddressLine1)) {
            $buyerAgentTradeParty->getPostalTradeAddressWithCreate()->getLineOneWithCreate()->setValue($newAddressLine1);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newAddressLine2)) {
            $buyerAgentTradeParty->getPostalTradeAddressWithCreate()->getLineTwoWithCreate()->setValue($newAddressLine2);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newAddressLine3)) {
            $buyerAgentTradeParty->getPostalTradeAddressWithCreate()->getLineThreeWithCreate()->setValue($newAddressLine3);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newPostcode)) {
            $buyerAgentTradeParty->getPostalTradeAddressWithCreate()->getPostcodeCodeWithCreate()->setValue($newPostcode);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newCity)) {
            $buyerAgentTradeParty->getPostalTradeAddressWithCreate()->getCityNameWithCreate()->setValue($newCity);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newSubDivision)) {
            $buyerAgentTradeParty->getPostalTradeAddressWithCreate()->getCountrySubDivisionNameWithCreate()->setValue($newSubDivision);
        }
    ...
    public function addDocumentBuyerAgentAddress(
        ...
        $this->setDocumentBuyerAgentAddress(
            $newAddressLine1,
            $newAddressLine2,
            $newAddressLine3,
            $newPostcode,
     ...
     *
     * @param  null|string $newType __BT-X-410-0, From EXTENDED__ Type of the identification number of the legal registration of the party
     * @param  null|string $newId   __BT-X-410, From EXTENDED__ Identification number of the legal registration of the party
     * @param  null|string $newName __BT-X-407, From EXTENDED__ Name by which the party is known, if different from the party's name
     * @return static
     */
    public function setDocumentBuyerAgentLegalOrganisation(
        ...
        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newId)) {
            $buyerAgentTradeParty->getSpecifiedLegalOrganizationWithCreate()->getIDWithCreate()->setValue($newId);

            if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newType)) {
                $buyerAgentTradeParty->getSpecifiedLegalOrganization()->getID()->setSchemeID($newType);
            }
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newName)) {
            $buyerAgentTradeParty->getSpecifiedLegalOrganizationWithCreate()->getTradingBusinessNameWithCreate()->setValue($newName);
        }
    ...
    public function addDocumentBuyerAgentLegalOrganisation(
        ...
        $this->setDocumentBuyerAgentLegalOrganisation($newType, $newId, $newName);
     ...
     *
     * @param  null|string $newPersonName     __BT-X-413, From EXTENDED__ Name of contact person or department or office for the contact point
     * @param  null|string $newDepartmentName __BT-X-414, From EXTENDED__ Name of the department for the contact point
     * @param  null|string $newPhoneNumber    __BT-X-416, From EXTENDED__ Telephone number for the contact point
     * @param  null|string $newFaxNumber      __BT-X-417, From EXTENDED__ Fax number of the contact point
     * @param  null|string $newEmailAddress   __BT-X-418, From EXTENDED__ E-Mail address of the contact point
     * @return static
     */
    public function setDocumentBuyerAgentContact(
        ...
        $this->addDocumentBuyerAgentContact(
            $newPersonName,
            $newDepartmentName,
            $newPhoneNumber,
            $newFaxNumber,
    ...
    public function addDocumentBuyerAgentContact(
        ...
        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newPersonName)) {
            $buyerAgentTradeContact->getPersonNameWithCreate()->setValue($newPersonName);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newDepartmentName)) {
            $buyerAgentTradeContact->getDepartmentNameWithCreate()->setValue($newDepartmentName);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newPhoneNumber)) {
            $buyerAgentTradeContact->getTelephoneUniversalCommunicationWithCreate()->getCompleteNumberWithCreate()->setValue($newPhoneNumber);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newFaxNumber)) {
            $buyerAgentTradeContact->getFaxUniversalCommunicationWithCreate()->getCompleteNumberWithCreate()->setValue($newFaxNumber);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newEmailAddress)) {
            $buyerAgentTradeContact->getEmailURIUniversalCommunicationWithCreate()->getURIIDWithCreate()->setValue($newEmailAddress);
        }
     ...
     *
     * @param  null|string $newType __BT-X-412-0, From EXTENDED__ The type for the party's electronic address
     * @param  null|string $newUri  __BT-X-412, From EXTENDED__ The party's electronic address
     * @return static
     */
    public function setDocumentBuyerAgentCommunication(
        ...
        $buyerAgentUniversalCommunication = $this
            ->getCrossIndustryRootObject()
            ->getSupplyChainTradeTransactionWithCreate()
            ->getApplicableHeaderTradeAgreementWithCreate()
            ->getBuyerAgentTradePartyWithCreate()
        ...
        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newType)) {
            $buyerAgentUniversalCommunication->getURIIDWithCreate()->setSchemeID($newType);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newUri)) {
            $buyerAgentUniversalCommunication->getURIIDWithCreate()->setValue($newUri);
        }
    ...
    public function addDocumentBuyerAgentCommunication(
        ...
        $this->setDocumentBuyerAgentCommunication($newType, $newUri);
    ...
    public function setDocumentSpecifiedAdvancePayment(
        ...
        $this
            ...
            ->getSupplyChainTradeTransaction()
            ?->getApplicableHeaderTradeSettlement()
            ?->unsetSpecifiedAdvancePayment();

        if (InvoiceSuiteFloatUtils::floatIsNullOrEmpty($newPaidAmount)) {
            return $this->traceMethodEarlyExit(__METHOD__, 'floatIsNullOrEmpty', 'InvoiceSuiteFloatUtils::floatIsNullOrEmpty($newPaidAmount)');
        }

        $this->addDocumentSpecifiedAdvancePayment($newPaidAmount, $newFormattedReceivedDateTime);
    ...
    public function addDocumentSpecifiedAdvancePayment(
        ...
        $specifiedAdvancePayment = $this
            ->getCrossIndustryRootObject()
            ->getSupplyChainTradeTransactionWithCreate()
            ->getApplicableHeaderTradeSettlementWithCreate()
            ->addToSpecifiedAdvancePaymentWithCreate();

        $specifiedAdvancePayment->getPaidAmountWithCreate()->setValue($newPaidAmount);

        if (!InvoiceSuiteDateTimeUtils::dateTimeIsNullOrEmpty($newFormattedReceivedDateTime)) {
            $specifiedAdvancePayment
                ->getFormattedReceivedDateTimeWithCreate()
                ->getDateTimeStringWithCreate()
                ->setValue($newFormattedReceivedDateTime->format('Ymd'))
                ->setFormat('102');
        }
    ...
    public function setDocumentSpecifiedAdvancePaymentIncludedTradeTax(
        ...
        $specifiedAdvancePayment = InvoiceSuiteArrayUtils::last($specifiedAdvancePayments);

        if (false === $specifiedAdvancePayment) {
            $this->traceMethodExit(__METHOD__);
    ...
    public function addDocumentSpecifiedAdvancePaymentIncludedTradeTax(
        ...
        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newExemptionReason)) {
            $includedTradeTax->getExemptionReasonWithCreate()->setValue($newExemptionReason);
        }

        if (!InvoiceSuiteStringUtils::stringIsNullOrEmpty($newExemptionReasonCode)) {
            $includedTradeTax->getExemptionReasonCodeWithCreate()->setValue($newExemptionReasonCode);
        }
    ...
    public function setDocumentSpecifiedAdvancePaymentInvoiceReference(
        ...
        $specifiedAdvancePayment->unsetInvoiceSpecifiedReferencedDocument();

        if (InvoiceSuiteStringUtils::stringIsNullOrEmpty($newReferenceNumber)) {
            return $this->traceMethodEarlyExit(__METHOD__, 'stringIsNullOrEmpty', 'InvoiceSuiteStringUtils::stringIsNullOrEmpty($newReferenceNumber)');
        }

        $invoiceReference = $specifiedAdvancePayment->getInvoiceSpecifiedReferencedDocumentWithCreate();
    ...
    private function updateMandates(): static
    {
        ...
        $paymentTerms = InvoiceSuiteArrayUtils::filter(
            $paymentTerms,
            static fn (TradePaymentTermsType $paymentTerm): bool => InvoiceSuiteStringUtils::stringIsNullOrEmpty(
