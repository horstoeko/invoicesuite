...
class InvoiceSuiteCtcFrUBLInvoiceProvider extends InvoiceSuitePeppol30InvoiceProvider
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        return 'CTC-FR EXTENDED (AFNOR XP Z12-012) - French extension of EN 16931 in UBL syntax (Invoice)';
    }
    ...
    public function getParameters(): array
    {
        return [
            ...
            // code (B1, S1, M1, B2, S2, M2, S3, B4, S4, M4, S5, ...) chosen per invoice, never a
    ...
    {
        return [InvoiceSuiteCtcFrUBLInvoiceSerializerHandler::class];
    }
     ...
     * per invoice, and which is sometimes absent altogether. Matching therefore only takes the
    ...
    {
        return InvoiceSuiteCtcFrUBLInvoiceProviderReader::class;
    }
    ...
    {
        return InvoiceSuiteCtcFrUBLInvoiceProviderBuilder::class;
    }
}
