...
abstract class InvoiceSuiteAbstractDocumentBaseReader
{
     ...
     * @phpstan-param-out string $newName
     */
    abstract public function getDocumentSalesAgentName(
        ?string &$newName
    ): static;
     ...
     * @return bool
     */
    abstract public function firstDocumentSalesAgentId(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentSalesAgentId(): bool;
     ...
     * @phpstan-param-out string $newId
     */
    abstract public function getDocumentSalesAgentId(
        ?string &$newId
    ): static;
     ...
     * @return bool
     */
    abstract public function firstDocumentSalesAgentGlobalId(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentSalesAgentGlobalId(): bool;
     ...
     * @phpstan-param-out string $newGlobalIdType
     */
    abstract public function getDocumentSalesAgentGlobalId(
        ?string &$newGlobalId,
        ?string &$newGlobalIdType
    ): static;
     ...
     * @return bool
     */
    abstract public function firstDocumentSalesAgentTaxRegistration(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentSalesAgentTaxRegistration(): bool;
     ...
     * @phpstan-param-out string $newTaxRegistrationId
     */
    abstract public function getDocumentSalesAgentTaxRegistration(
        ?string &$newTaxRegistrationType,
        ?string &$newTaxRegistrationId
    ): static;
     ...
     * @return bool
     */
    abstract public function firstDocumentSalesAgentAddress(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentSalesAgentAddress(): bool;
     ...
     * @phpstan-param-out string $newSubDivision
     */
    abstract public function getDocumentSalesAgentAddress(
        ?string &$newAddressLine1,
        ?string &$newAddressLine2,
        ?string &$newAddressLine3,
        ?string &$newPostcode,
     ...
     * @return bool
     */
    abstract public function firstDocumentSalesAgentLegalOrganisation(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentSalesAgentLegalOrganisation(): bool;
     ...
     * @phpstan-param-out string $newName
     */
    abstract public function getDocumentSalesAgentLegalOrganisation(
        ?string &$newType,
        ?string &$newId,
        ?string &$newName
    ): static;
     ...
     * @return bool
     */
    abstract public function firstDocumentSalesAgentContact(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentSalesAgentContact(): bool;
     ...
     * @phpstan-param-out string $newEmailAddress
     */
    abstract public function getDocumentSalesAgentContact(
        ?string &$newPersonName,
        ?string &$newDepartmentName,
        ?string &$newPhoneNumber,
        ?string &$newFaxNumber,
     ...
     * @return bool
     */
    abstract public function firstDocumentSalesAgentCommunication(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentSalesAgentCommunication(): bool;
     ...
     * @phpstan-param-out string $newUri
     */
    abstract public function getDocumentSalesAgentCommunication(
        ?string &$newType,
        ?string &$newUri
    ): static;
     ...
     * @return bool
     */
    abstract public function firstDocumentPayerId(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentPayerId(): bool;
     ...
     * @phpstan-param-out string $newId
     */
    abstract public function getDocumentPayerId(
        ?string &$newId
    ): static;
     ...
     * @return bool
     */
    abstract public function firstDocumentPayerGlobalId(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentPayerGlobalId(): bool;
     ...
     * @phpstan-param-out string $newGlobalIdType
     */
    abstract public function getDocumentPayerGlobalId(
        ?string &$newGlobalId,
        ?string &$newGlobalIdType
    ): static;
     ...
     * @return bool
     */
    abstract public function firstDocumentPayerTaxRegistration(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentPayerTaxRegistration(): bool;
     ...
     * @phpstan-param-out string $newTaxRegistrationId
     */
    abstract public function getDocumentPayerTaxRegistration(
        ?string &$newTaxRegistrationType,
        ?string &$newTaxRegistrationId
    ): static;
     ...
     * @return bool
     */
    abstract public function firstDocumentPayerAddress(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentPayerAddress(): bool;
     ...
     * @phpstan-param-out string $newSubDivision
     */
    abstract public function getDocumentPayerAddress(
        ?string &$newAddressLine1,
        ?string &$newAddressLine2,
        ?string &$newAddressLine3,
        ?string &$newPostcode,
     ...
     * @return bool
     */
    abstract public function firstDocumentPayerLegalOrganisation(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentPayerLegalOrganisation(): bool;
     ...
     * @phpstan-param-out string $newName
     */
    abstract public function getDocumentPayerLegalOrganisation(
        ?string &$newType,
        ?string &$newId,
        ?string &$newName
    ): static;
     ...
     * @return bool
     */
    abstract public function firstDocumentPayerContact(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentPayerContact(): bool;
     ...
     * @phpstan-param-out string $newEmailAddress
     */
    abstract public function getDocumentPayerContact(
        ?string &$newPersonName,
        ?string &$newDepartmentName,
        ?string &$newPhoneNumber,
        ?string &$newFaxNumber,
     ...
     * @return bool
     */
    abstract public function firstDocumentPayerCommunication(): bool;
     ...
     * @return bool
     */
    abstract public function nextDocumentPayerCommunication(): bool;
     ...
     * @phpstan-param-out string $newUri
     */
    abstract public function getDocumentPayerCommunication(
        ?string &$newType,
        ?string &$newUri
    ): static;
