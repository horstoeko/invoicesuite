...
class DependentPriceReferenceType
{
    ...
    /**
     * @var \horstoeko\invoicesuite\documentmodels\ubl\cac\LocationAddress|null
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documentmodels\ubl\cac\LocationAddress")
     * @JMS\Expose
    ...
    /**
     * @var \horstoeko\invoicesuite\documentmodels\ubl\cac\DependentLineReference|null
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\documentmodels\ubl\cac\DependentLineReference")
     * @JMS\Expose
    ...
    /**
     * @return \horstoeko\invoicesuite\documentmodels\ubl\cac\LocationAddress|null
     */
    ...
    /**
     * @return \horstoeko\invoicesuite\documentmodels\ubl\cac\LocationAddress
     */
    ...
    /**
     * @param \horstoeko\invoicesuite\documentmodels\ubl\cac\LocationAddress|null $locationAddress
     * @return self
     */
    ...
    /**
     * @return \horstoeko\invoicesuite\documentmodels\ubl\cac\DependentLineReference|null
     */
    ...
    /**
     * @return \horstoeko\invoicesuite\documentmodels\ubl\cac\DependentLineReference
     */
    ...
    /**
     * @param \horstoeko\invoicesuite\documentmodels\ubl\cac\DependentLineReference|null $dependentLineReference
     * @return self
     */
