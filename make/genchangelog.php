...
function getMarkDown($prevTag, $currTag): array
{
    ...
    if ([] !== $commits) {
        ...
        foreach ($commits as $commit) {
            ...
            $commitIssuesWithUrls = array_map(static fn ($issue): string => sprintf('[%1$s](https://github.com/horstoeko/invoicesuite/issues/%2$s)', $issue, substr((string) $issue, 1)), $commitIssues);
