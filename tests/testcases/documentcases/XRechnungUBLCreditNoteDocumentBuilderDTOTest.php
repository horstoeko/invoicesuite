...
final class XRechnungUBLCreditNoteDocumentBuilderDTOTest extends TestCase
{
    ...
    public function testMessageBag(): void
    {
        ...
        $this->assertSame(122, static::$document->countMessagesInMessageBagBySeverity(InvoiceSuiteMessageSeverity::INFO));
        ...
        $this->assertSame(122, static::$document->countInfoMessagesInMessageBag());
