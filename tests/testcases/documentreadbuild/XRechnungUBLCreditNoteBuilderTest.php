...
final class XRechnungUBLCreditNoteBuilderTest extends TestCase
{
    ...
    public function testSetAddDocumentAdditionalReference(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject[@mimeCode="text/plain"]', 'VGhpcyBpcyBhIHRlc3Q=');
        $this->assertXPathValue('/ns:CreditNote/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject[@filename="test.txt"]', 'VGhpcyBpcyBhIHRlc3Q=');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AdditionalDocumentReference/cbc:ID)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AdditionalDocumentReference/cbc:IssueDate)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AdditionalDocumentReference/cbc:DocumentTypeCode)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AdditionalDocumentReference/cbc:DocumentDescription)[2]');
    ...
    public function testSetAddDocumentSellerDescription(): void
    {
        ...
        $this->assertXPathNotExists('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyLegalForm');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyLegalForm)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyLegalForm', 'Seller Description');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyLegalForm)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyLegalForm', 'Seller Description 2');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyLegalForm)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyLegalForm', 'Seller Description 3');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyLegalForm)[2]');
    }
    ...
    public function testSetDocumentSellerRoleCode(): void
    {
        ...
        $this->assertXPathNotExists('/ns:CreditNote//cbc:RoleCode');
    ...
    public function testSetAddDocumentSellerGlobalId(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID', 'Seller Id 3');
        $this->assertXPathValue('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[2][@schemeID="0088"]', 'Seller Global Id 1');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID', 'Seller Id 3');
        $this->assertXPathValue('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[2][@schemeID="0088"]', 'Seller Global Id 1');
        $this->assertXPathValue('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[3][@schemeID="0088"]', 'Seller Global Id 2');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID', 'Seller Id 3');
        $this->assertXPathValue('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[2][@schemeID="0088"]', 'Seller Global Id 3');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[3]');
    }
    ...
    public function testSetAddDocumentSellerCommunication(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID[@schemeID="EM"]', 'user@somewhere.all');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID[@schemeID="EM"]', 'user2@somewhere.all');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID)[2]');
    }
    ...
    public function testSetAddDocumentBuyerDescription(): void
    {
        ...
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyLegalForm)[2]');
    ...
    public function testSetAddDocumentBuyerGlobalId(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID="0088"]', 'Buyer Global Id 1');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID="0088"]', 'Buyer Global Id 2');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID="0088"]', 'Buyer Global Id 3');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID)[2]');
    }
    ...
    public function testSetAddDocumentBuyerCommunication(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID[@schemeID="EM"]', 'user@somewhere.all');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID[@schemeID="EM"]', 'user2@somewhere.all');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID)[2]');
    }
    ...
    public function testSetAddDocumentSellerTaxRepresentativeDescription(): void
    {
        ...
        $this->assertXPathNotExists('(/ns:CreditNote/cac:TaxRepresentativeParty/cac:PartyLegalEntity/cbc:CompanyLegalForm)[2]');
    ...
    public function testSetAddDocumentShipToDescription(): void
    {
        ...
        $this->assertXPathNotExists('(/ns:CreditNote/cac:Delivery/cac:DeliveryParty/cac:PartyLegalEntity/cbc:CompanyLegalForm)[2]');
    ...
    public function testSetAddDocumentShipToGlobalId(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cbc:ID[@schemeID="0088"]', 'Ship To Global Id 1');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cbc:ID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cbc:ID[@schemeID="0088"]', 'Ship To Global Id 2');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cbc:ID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cbc:ID[@schemeID="0088"]', 'Ship To Global Id 3');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cbc:ID)[2]');
    }
    ...
    public function testSetAddDocumentPayeeDescription(): void
    {
        ...
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PayeeParty/cac:PartyLegalEntity/cbc:CompanyLegalForm)[2]');
    ...
    public function testSetAddDocumentPayeeGlobalId(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:PayeeParty/cac:PartyIdentification/cbc:ID[@schemeID="0088"]', 'Payee Global Id 1');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PayeeParty/cac:PartyIdentification/cbc:ID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:PayeeParty/cac:PartyIdentification/cbc:ID[@schemeID="0088"]', 'Payee Global Id 2');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PayeeParty/cac:PartyIdentification/cbc:ID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:PayeeParty/cac:PartyIdentification/cbc:ID[@schemeID="0088"]', 'Payee Global Id 3');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PayeeParty/cac:PartyIdentification/cbc:ID)[2]');
    }
    ...
    public function testSetAddDocumentPaymentMean(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cbc:PaymentMeansCode[@name="information"]', InvoiceSuiteCodelistPaymentMeans::UNTDID_4461_58->value);
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cbc:PaymentMeansCode)[2]');
    ...
    public function testSetDocumentSummation(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:TaxTotal/cbc:TaxAmount[@currencyID="EUR"]', '5.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount[@currencyID="EUR"]', '1.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount[@currencyID="EUR"]', '4.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount[@currencyID="EUR"]', '7.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount[@currencyID="EUR"]', '3.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount[@currencyID="EUR"]', '2.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:PrepaidAmount[@currencyID="EUR"]', '9.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:PayableRoundingAmount[@currencyID="EUR"]', '10.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount[@currencyID="EUR"]', '8.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:TaxTotal/cbc:TaxAmount)[2][@currencyID="GBP"]', '6.00');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:TaxTotal/cbc:TaxAmount[not(@currencyID)]', '5.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount[not(@currencyID)]', '1.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount[not(@currencyID)]', '4.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount[not(@currencyID)]', '7.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount[not(@currencyID)]', '3.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount[not(@currencyID)]', '2.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:PrepaidAmount[not(@currencyID)]', '9.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:PayableRoundingAmount[not(@currencyID)]', '10.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount[not(@currencyID)]', '8.00');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:TaxTotal/cbc:TaxAmount)[2]'); // No Tax Currency present
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount)[2]');
    ...
    public function testSetDocumentPositionProductDetails(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification/cbc:ID[@schemeID="productglobalidtype"]', 'productglobalid');
    ...
    public function testSetAddDocumentPositionProductCharacteristic(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification/cbc:ID[@schemeID="productglobalidtype2"]', 'productglobalid2');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification/cbc:ID[@schemeID="productglobalidtype3"]', 'productglobalid3');
    ...
    public function testSetDocumentPositionProductClassification(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode[@listID="listid"]', 'classcode');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode[@listVersionID="listversionid"]', 'classcode');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode)[2]');
        ...
        $this->assertXPathValue('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode)[2][@listID="listid2"]', 'classcode2');
        $this->assertXPathValue('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode)[2][@listVersionID="listversionid2"]', 'classcode2');
    ...
    public function testSetDocumentPositionNetPrice(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Price/cbc:BaseQuantity[@unitCode="C62"]', '2.00');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Price)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Price/cbc:PriceAmount)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Price/cbc:BaseQuantity)[2]');
    ...
    public function testSetDocumentPositionQuantities(): void
    {
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cbc:CreditedQuantity[@unitCode="C62"]', '1.00');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cbc:CreditedQuantity)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cbc:CreditedQuantity[@unitCode="XPP"]', '4.00');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cbc:CreditedQuantity)[2]');
    ...
    public function testCreateFromDTO(): void
    {
        ...
        $this->assertXPathNotExists('(/ns:CreditNote/cbc:ID)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cbc:CreditNoteTypeCode)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cbc:IssueDate)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cbc:DocumentCurrencyCode)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cbc:TaxCurrencyCode)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cbc:TaxPointDate)[2]');

        $this->assertXPathValue('/ns:CreditNote/cbc:Note', 'Some content');
        $this->assertXPathNotExists('(/ns:CreditNote/cbc:Note)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cbc:AccountingCost', 'PREF-1');
        $this->assertXPathNotExists('(/ns:CreditNote/cbc:AccountingCost)[2]');
        ...
        $this->assertXPathNotExists('/ns:CreditNote/cac:AdditionalDocumentReference/cbc:IssueDate');
        $this->assertXPathNotExists('/ns:CreditNote/cac:AdditionalDocumentReference/cbc:DocumentTypeCode');
        $this->assertXPathValue('/ns:CreditNote/cac:AdditionalDocumentReference/cbc:DocumentDescription', 'description');
        $this->assertXPathValue('(/ns:CreditNote/cac:AdditionalDocumentReference/cbc:ID)[2]', 'ADD-2');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AdditionalDocumentReference/cbc:IssueDate)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AdditionalDocumentReference/cbc:DocumentTypeCode)[2]');
        $this->assertXPathValue('(/ns:CreditNote/cac:AdditionalDocumentReference/cbc:DocumentDescription)[2]', 'description2');
        ...
        $this->assertXPathValue('/ns:CreditNote/cbc:BuyerReference', 'LEITWEGID');
        $this->assertXPathNotExists('(/ns:CreditNote/cbc:BuyerReference)[2]');
        ...
        $this->assertXPathValue('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[2]', '0815-4712');
        $this->assertXPathValue('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[3][@schemeID="0088"]', '11111');
        $this->assertXPathValue('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[4][@schemeID="0088"]', '22222');
        $this->assertXPathExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[5]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[6]');

        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID', '893489787987');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID', 'VAT');
        $this->assertXPathValue('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID)[2]', '893489787987-X');
        $this->assertXPathValue('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID)[2]', 'FC');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID)[3]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID)[3]');

        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:PostalZone', '06108');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:StreetName', 'Line 1');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName', 'Line 2');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CityName', 'City');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode', 'DE');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID', '3874837489237');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name', 'Lieferant AG');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name)[2]');

        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Name', 'Horst Meier');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telephone', '0815-4711');
        $this->assertXPathNotExists('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telefax');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail', 'horst.meier@lieferant.de');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Name)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telephone)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telefax)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail)[2]');

        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID[@schemeID="EM"]', 'info@lieferant.de');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID', '893489787987');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID', 'VAT');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID)[2]');

        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone', '06108');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName', 'Line 1');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName', 'Line 2');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName', 'City');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode', 'DE');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID', '3874837489237');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name', 'Kunde AG');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name)[2]');

        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Name', 'Horst Meier');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telephone', '0815-4711');
        $this->assertXPathNotExists('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telefax');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail', 'horst.meier@kunde.de');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Name)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telephone)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telefax)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail)[2]');

        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID[@schemeID="EM"]', 'info@kunde.de');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cbc:CompanyID', '893489787987');
        $this->assertXPathValue('/ns:CreditNote/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID', 'VAT');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cbc:CompanyID)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID)[2]');

        $this->assertXPathValue('/ns:CreditNote/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:PostalZone', '06108');
        $this->assertXPathValue('/ns:CreditNote/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:StreetName', 'Line 1');
        $this->assertXPathValue('/ns:CreditNote/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:AdditionalStreetName', 'Line 2');
        $this->assertXPathValue('/ns:CreditNote/cac:TaxRepresentativeParty/cac:PostalAddress/cbc:CityName', 'City');
        $this->assertXPathValue('/ns:CreditNote/cac:TaxRepresentativeParty/cac:PostalAddress/cac:Country/cbc:IdentificationCode', 'DE');
        ...
        $this->assertXPathNotExists('/ns:CreditNote/cac:BuyerAgentParty');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:PostalZone', '06108');
        $this->assertXPathValue('/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName', 'Line 1');
        $this->assertXPathValue('/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:AdditionalStreetName', 'Line 2');
        $this->assertXPathValue('/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:CityName', 'City');
        $this->assertXPathValue('/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country/cbc:IdentificationCode', 'DE');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:PayeeParty/cac:PartyLegalEntity/cbc:CompanyID', '3874837489237');
        $this->assertXPathNotExists('/ns:CreditNote/cac:PayeeParty/cac:PartyLegalEntity/cbc:RegistrationName');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PayeeParty/cac:PartyLegalEntity/cbc:CompanyID)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PayeeParty/cac:PartyLegalEntity/cbc:RegistrationName)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cbc:PaymentMeansCode', 'typecode');
        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cbc:PaymentID', 'paymentReference');
        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cac:PaymentMandate/cbc:ID', 'mandate');
        $this->assertXPathValue('(/ns:CreditNote/cac:PaymentMeans/cbc:PaymentMeansCode)[2]', 'typecode2');
        $this->assertXPathValue('(/ns:CreditNote/cac:PaymentMeans/cbc:PaymentID)[2]', 'paymentReference2');
        $this->assertXPathValue('(/ns:CreditNote/cac:PaymentMeans/cac:PaymentMandate/cbc:ID)[2]', 'mandate2');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cbc:PaymentMeansCode)[3]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cbc:PaymentID)[3]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cac:PaymentMandate/cbc:ID)[3]');

        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cac:CardAccount/cbc:PrimaryAccountNumberID', 'financialCardId');
        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cac:CardAccount/cbc:NetworkID', 'mapped-from-cii');
        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cac:CardAccount/cbc:HolderName', 'financialCardHolder');
        $this->assertXPathValue('(/ns:CreditNote/cac:PaymentMeans/cac:CardAccount/cbc:PrimaryAccountNumberID)[2]', 'financialCardId2');
        $this->assertXPathValue('(/ns:CreditNote/cac:PaymentMeans/cac:CardAccount/cbc:NetworkID)[2]', 'mapped-from-cii');
        $this->assertXPathValue('(/ns:CreditNote/cac:PaymentMeans/cac:CardAccount/cbc:HolderName)[2]', 'financialCardHolder2');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cac:CardAccount/cbc:PrimaryAccountNumberID)[3]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cac:CardAccount/cbc:NetworkID)[3]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cac:CardAccount/cbc:HolderName)[3]');

        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID', 'payeeiban');
        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:Name', 'payeeaccountname');
        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID', 'payeeBic');
        $this->assertXPathValue('(/ns:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID)[2]', 'payeeiban2');
        $this->assertXPathValue('(/ns:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:Name)[2]', 'payeeaccountname2');
        $this->assertXPathValue('(/ns:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID)[2]', 'payeeBic2');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID)[3]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:Name)[3]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cbc:ID)[3]');

        $this->assertXPathValue('/ns:CreditNote/cac:PaymentMeans/cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID', 'buyeriban');
        $this->assertXPathValue('(/ns:CreditNote/cac:PaymentMeans/cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID)[2]', 'buyeriban2');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentMeans/cac:PaymentMandate/cac:PayerFinancialAccount/cbc:ID)[3]');

        // Payment Term

        $this->assertXPathValue('/ns:CreditNote/cac:PaymentTerms/cbc:Note', 'Payment Term Description 1');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:PaymentTerms/cbc:Note)[2]');

        // Creditor Reference

        $this->assertXPathValue("/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='SEPA']", 'CREDREF-1');
        $this->assertXPathNotExists("(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='SEPA'])[2]");
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID', 'VAT');
        $this->assertXPathValue('(/ns:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount)[2]', '100.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount)[2]', '7.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID)[2]', 'S');
        $this->assertXPathValue('(/ns:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:Percent)[2]', '7.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReasonCode)[2]', 'ReasonCode2');
        $this->assertXPathValue('(/ns:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReason)[2]', 'Reason2');
        $this->assertXPathValue('(/ns:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID)[2]', 'VAT');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount)[3]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode', 'ReasonCode');
        $this->assertXPathValue('/ns:CreditNote/cac:AllowanceCharge/cbc:AllowanceChargeReason', 'Reason');
        $this->assertXPathValue('/ns:CreditNote/cac:AllowanceCharge/cbc:MultiplierFactorNumeric', '10.00');
        $this->assertXPathValue('/ns:CreditNote/cac:AllowanceCharge/cbc:Amount', '10.00');
        $this->assertXPathValue('/ns:CreditNote/cac:AllowanceCharge/cbc:BaseAmount', '100.00');
        $this->assertXPathValue('/ns:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cbc:ID', 'S');
        $this->assertXPathValue('/ns:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cbc:Percent', '19.00');
        $this->assertXPathValue('/ns:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme/cbc:ID', 'VAT');
        $this->assertXPathValue('(/ns:CreditNote/cac:AllowanceCharge/cbc:ChargeIndicator)[2]', 'false');
        $this->assertXPathValue('(/ns:CreditNote/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode)[2]', 'ReasonCode2');
        $this->assertXPathValue('(/ns:CreditNote/cac:AllowanceCharge/cbc:AllowanceChargeReason)[2]', 'Reason2');
        $this->assertXPathValue('(/ns:CreditNote/cac:AllowanceCharge/cbc:MultiplierFactorNumeric)[2]', '1.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:AllowanceCharge/cbc:Amount)[2]', '1.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:AllowanceCharge/cbc:BaseAmount)[2]', '10.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cbc:ID)[2]', 'S');
        $this->assertXPathValue('(/ns:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cbc:Percent)[2]', '19.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme/cbc:ID)[2]', 'VAT');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AllowanceCharge/cbc:ChargeIndicator)[3]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:PayableRoundingAmount', '10.00');
        $this->assertXPathValue('/ns:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount', '8.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:TaxTotal/cbc:TaxAmount)[2]', '6.00');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cbc:ID', '1.1');
        $this->assertXPathValue('(/ns:CreditNote/cac:CreditNoteLine/cbc:ID)[2]', '2.1');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cbc:ID)[3]');

        // Position Note

        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cbc:Note', 'CONTENT-1');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cbc:Note)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cbc:Note)[3]');
        ...
        $this->assertXPathExists('/ns:CreditNote/cac:CreditNoteLine/cac:Item');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cbc:Description', 'PRODUCTDESC-1');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cbc:Name', 'PRODUCTNAME-1');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:BuyersItemIdentification/cbc:ID', 'PRODUCTBUYER-1');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:SellersItemIdentification/cbc:ID', 'PRODUCTSELLERID-1');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification/cbc:ID[@schemeID="PRODUCTGLOBALIDTYPE-1"]', 'PRODUCTGLOBALID-1');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:OriginCountry/cbc:IdentificationCode', 'PRODUCTCOUNTRY-1');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cbc:Description)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cbc:Name)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:BuyersItemIdentification/cbc:ID)[2]');
        ...
        $this->assertXPathExists('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty/cbc:Name', 'PRODUCTCHARACTERISTICDESC-1');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty/cbc:Value', 'PRODUCTCHARACTERISTICVALUE-1');
        $this->assertXPathNotExists('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty/cbc:ValueQuantity');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty/cbc:Name)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty/cbc:Value)[2]');
        ...
        $this->assertXPathExists('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode[@listID="PRODUCTLISTID-1"]', 'PRODUCTCLASSCODE-1');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode[@listVersionID="PRODUCTLISTVERSIONID-1"]', 'PRODUCTCLASSCODE-1');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode)[2]');
        ...
        $this->assertXPathExists('/ns:CreditNote/cac:CreditNoteLine/cac:OrderLineReference');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:OrderLineReference/cbc:LineID', '10');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:OrderLineReference)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:OrderLineReference/cbc:LineID)[2]');
        ...
        $this->assertXPathExists('/ns:CreditNote/cac:CreditNoteLine/cac:DocumentReference');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:DocumentReference/cbc:ID', 'OBJ-1');
        $this->assertXPathNotExists('/ns:CreditNote/cac:CreditNoteLine/cac:DocumentReference/cbc:DocumentTypeCode');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:DocumentReference)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:DocumentReference/cbc:ID)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cbc:AccountingCost', 'PREF-1');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cbc:AccountingCost)[2]');
        ...
        $this->assertXPathExists('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID', 'S');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cbc:Percent', '7.00');
        $this->assertXPathNotExists('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cbc:TaxExemptionReasonCode');
        $this->assertXPathNotExists('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cbc:TaxExemptionReason');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme/cbc:ID', 'VAT');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory)[2]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:AllowanceChargeReason', 'Reason');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:MultiplierFactorNumeric', '10.00');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:Amount', '10.00');
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:BaseAmount', '100.00');
        $this->assertXPathExists('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge)[2]');
        $this->assertXPathValue('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:ChargeIndicator)[2]', 'false');
        $this->assertXPathValue('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode)[2]', 'ReasonCode2');
        $this->assertXPathValue('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:AllowanceChargeReason)[2]', 'Reason2');
        $this->assertXPathValue('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:MultiplierFactorNumeric)[2]', '1.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:Amount)[2]', '1.00');
        $this->assertXPathValue('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:BaseAmount)[2]', '10.00');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge)[3]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:ChargeIndicator)[3]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode)[3]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge/cbc:AllowanceChargeReason)[3]');
        ...
        $this->assertXPathValue('/ns:CreditNote/cac:CreditNoteLine/cbc:LineExtensionAmount', '100.00');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cbc:LineExtensionAmount)[2]');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line', 'Line 3');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line)[2]');
        $this->assertXPathValue('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line', 'Line 3');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:AddressLine/cbc:Line)[2]');
        $this->assertXPathValue('/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:AddressLine/cbc:Line', 'Line 3');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:AddressLine/cbc:Line)[2]');
        $this->assertXPathValue('/ns:CreditNote/cac:TaxRepresentativeParty/cac:PostalAddress/cac:AddressLine/cbc:Line', 'Line 3');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:TaxRepresentativeParty/cac:PostalAddress/cac:AddressLine/cbc:Line)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReason)[3]');
    }
}
