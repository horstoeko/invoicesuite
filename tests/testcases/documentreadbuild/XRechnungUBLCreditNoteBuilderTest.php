...
final class XRechnungUBLCreditNoteBuilderTest extends TestCase
{
    ...
    public function testCreateFromDTO(): void
    {
        ...
        $this->assertXPathValueWithAttribute('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[3]', '11111', 'schemeID', '0088');
        $this->assertXPathValueWithAttribute('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID)[4]', '22222', 'schemeID', '0088');
        ...
        $this->assertXPathValueWithAttribute('/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID', 'info@lieferant.de', 'schemeID', 'EM');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID)[2]');
        ...
        $this->assertXPathValueWithAttribute('/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID', 'info@kunde.de', 'schemeID', 'EM');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID)[2]');
        ...
        $this->assertXPathValueWithAttribute('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification/cbc:ID', 'PRODUCTGLOBALID-1', 'schemeID', 'PRODUCTGLOBALIDTYPE-1');
        ...
        $this->assertXPathExists('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification');
        $this->assertXPathValueWithAttribute('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode', 'PRODUCTCLASSCODE-1', 'listID', 'PRODUCTLISTID-1');
        $this->assertXPathValueWithAttribute('/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode', 'PRODUCTCLASSCODE-1', 'listVersionID', 'PRODUCTLISTVERSIONID-1');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification)[2]');
        $this->assertXPathNotExists('(/ns:CreditNote/cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode)[2]');
