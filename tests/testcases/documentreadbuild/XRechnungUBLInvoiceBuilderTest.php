...
final class XRechnungUBLInvoiceBuilderTest extends TestCase
{
    ...
    public function testSetAddDocumentBuyerTaxRegistration(): void
    {
        ...
        $this->assertXPathValueWithIndex('/ns:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID', 1, 'VAT');
    ...
    public function testSetAddDocumentTaxRepresentativeTaxRegistration(): void
    {
        ...
        $this->assertXPathValueWithIndex('/ns:Invoice/cac:TaxRepresentativeParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID', 1, 'VAT');
    ...
    public function testSetAddDocumentPayeeTaxRegistration(): void
    {
        ...
        $this->assertXPathValueWithIndex('/ns:Invoice/cac:PayeeParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID', 0, 'VAT');
        $this->assertXPathNotExistsWithIndex('/ns:Invoice/cac:PayeeParty/cac:PartyTaxScheme/cbc:CompanyID', 1);
        $this->assertXPathNotExistsWithIndex('/ns:Invoice/cac:PayeeParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID', 1);
        ...
        $this->assertXPathValueWithIndex('/ns:Invoice/cac:PayeeParty/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID', 1, 'VAT');
        ...
        $documentDTO
            ...
            ->setSellerParty(
                (new InvoiceSuitePartyDTO())
                    ...
                    ->addTaxRegistration(new InvoiceSuiteIdDTO('893489787987', 'VAT'))
                    ->addTaxRegistration(new InvoiceSuiteIdDTO('893489787987-X', 'FC'))
                    ->addTaxRegistration(new InvoiceSuiteIdDTO('893489787987-AA', 'VAT'))
