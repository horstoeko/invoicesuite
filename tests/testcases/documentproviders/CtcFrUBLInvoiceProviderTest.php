...
use horstoeko\invoicesuite\documents\providers\ctcfr\InvoiceSuiteCtcFrUBLInvoiceProviderReader;
use horstoeko\invoicesuite\documents\providers\ctcfr\InvoiceSuiteCtcFrUBLInvoiceSerializerHandler;
...
final class CtcFrUBLInvoiceProviderTest extends TestCase
{
    public function testGetUniqueId(): void
    {
        $provider = new InvoiceSuiteCtcFrUBLInvoiceProvider();
        $this->assertSame('ctcfrublinvoice', $provider->getUniqueId());
    }
    ...
    public function testIsRegisteredAsBuiltInProvider(): void
    {
        ...
        $this->assertSame(InvoiceSuiteBuiltInProviders::CTC_FR_UBL_INVOICE, $provider->getUniqueId());
    ...
    public function testGetSerializerHandlers(): void
    {
        ...
        $this->assertContains(InvoiceSuiteCtcFrUBLInvoiceSerializerHandler::class, $provider->getSerializerHandlers());
    }
    ...
    {
        $provider = new class extends InvoiceSuiteCtcFrUBLInvoiceProvider {
            /**
             * {@inheritDoc}
             */
            public function getParameters(): array
            {
                return array_merge(parent::getParameters(), ['AllowedDocumentTypes' => ['380']]);
            }
        };
        ...
        $this->assertTrue($provider->getIsSatisfiableBySerializedContent(sprintf($xmlTemplate, '380')));
        $this->assertFalse($provider->getIsSatisfiableBySerializedContent(sprintf($xmlTemplate, '381')));
    ...
    public function testGetReaderClassName(): void
    {
        ...
        $this->assertsame(InvoiceSuiteCtcFrUBLInvoiceProviderReader::class, $provider->getReaderClassName());
    }
    ...
    public function testGetBuilderClassName(): void
    {
        ...
        $this->assertsame(InvoiceSuiteCtcFrUBLInvoiceProviderBuilder::class, $provider->getBuilderClassName());
    }
}
